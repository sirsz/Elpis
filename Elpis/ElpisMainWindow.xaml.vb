...
Public Class ElpisMainWindow
    ...
    Private Sub buttonNavNew_Click(sender As Object, e As RoutedEventArgs) Handles buttonNavNew.Click
        ...
        If Not context_.TabSelected_ = Context.TabSelected.None Then
            Log("Info: The program context is empty - action canceled")
        End If
    ...
    Private Sub MIP_About_Click(sender As Object, e As RoutedEventArgs) Handles MIP_About.Click
        Log(MIH_ViewHelp.Header.ToString)
        MsgBox("Elips - The SIRSZ data manager" & Environment.NewLine & "v 1.2.2. Beta" & Environment.NewLine & "SIRS-Z © 2016 - 2017" & Environment.NewLine & "WWW: http://www.sirsz.pl/")
    End Sub
    ...
    Private Sub ITabItem2Ward_Search()
        ...
        result.Clear()
        result.Dispose()
        Log("Info: finished wards searching. Number of positions: " & rows_found_count)
    End Sub
    ...
    Sub ITabItem3Room_Search()
        ...
        result.Clear()
        result.Dispose()
        Log("Info: finished Searching room. Number of positions: " & rows_found_count)
    End Sub
    ...
    Sub ITabItem4Personel_Search()
        ...
        result.Clear()
        result.Dispose()
        Log("Info: finished Searching personnel. Number of positions: " & rows_found_count)
    End Sub
    ...
    Sub ITabItem6Visit_Search()
        ...
        result.Clear()
        result.Dispose()
        Log("Info: finished Searching wizits. Number of positions: " & rows_found_count)
    End Sub
    ...
    Sub ITabItem7LabTest_Search()
        ...
        result.Clear()
        result.Dispose()
        Log("Info: finished Searching tests. Number of positions: " & rows_found_count)
    End Sub
    ...
    Sub ITabItem8Duty_Search()
        ...
        result.Clear()
        result.Dispose()
        Log("Info: finished Searching Shifts. Number of positions: " & rows_found_count)
    End Sub
    ...
    Sub ITabItem6Visit_Update()
        ...
        If context_.currVisit_.IsInitialized Then
            ...
            Log("Info: Data updated " & context_.currVisit_.Get_f_Name)
            Dim result = My.Application.DatabaseSqliteInterface_.ExecuteQuerry(querry)
            result.Clear()
            result.Dispose()
        Else
    ...
    Sub ITabItem2Ward_Delete()
        ...
        If Not context_.TabSelected_ = Context.TabSelected.Ward Or context_.contextID_ < 0 Then
            ...
            Log("Error: Cannot delete Ward item - not selected")
            Return
        End If
    ...
    Sub ITabItem2Ward_New()
        ...
        If (context_.currWard_.Get_f_Id > -1) And (Not context_.currWard_.Get_f_Name = String.Empty) Then
            ...
            result.Dispose()
        Else
            MsgBox("Error: cannot add New department in database. Ward ID and name must be defined.")
        End If
    ...
    Sub ITabItem6Visit_New()
        ...
        If (Not context_.currVisit_.f_name_ = String.Empty) And (Not context_.currVisit_.Get_f_Date_In = String.Empty) Then
            ...
            Dim result = My.Application.DatabaseSqliteInterface_.ExecuteQuerry(insertQuerry)
            If Not result.HasErrors Then
                MsgBox("Info: New visit saved in the database: " & context_.currVisit_.Get_f_Name)
            End If
            result.Clear()
            result.Dispose()
        Else
    ...
    Sub ITabItem8Duty_New()
        ...
        If (Not context_.currDuty_.Get_f_Date = String.Empty) And (Not context_.currDuty_.Get_f_Personel_Id = String.Empty) Then
            ...
            Dim result = My.Application.DatabaseSqliteInterface_.ExecuteQuerry(insertQuerry)
            If Not result.HasErrors Then
                MsgBox("Info: Saved new Shift in the database: data:" & context_.currDuty_.Get_f_Date & ", Staff ID " & context_.currDuty_.f_personel_id_)
            End If
            result.Clear()
            result.Dispose()
        Else
    ...
    Sub ExportAllData()
        ...
        Log("Info: Data has been exported to the location: " & location_of_exported_data)
    End Sub
